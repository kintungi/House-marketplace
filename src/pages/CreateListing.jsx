...
function CreateListing() {
    ...
    const onMutate = (e) => {
        ...
        if(!e.target.files) {
            setFormData(prevState => ({
                ...prevState,
                [e.target.id]: boolean ?? e.target.value, //Nullish coellescing operator: if boolean is null use the e.target.value
            }))
        }
    }
    ...
    <div className='profile'>
      ...
      <main>
        <form onSubmit={onSubmit}>
            ...
            <input className='formInputName' type="text" name="name" id="name" value={name} onChange={onMutate} maxLength="32" minLength={10} required />
